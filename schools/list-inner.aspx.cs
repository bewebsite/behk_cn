...
/*            repBanner.DataSource = list;
    ...
    public string GetCounty()
    {
        ...
        if (list.Count > 0)
        {
            ...
            sb.AppendFormat("<a {1} href=\"/schools/list-inner.aspx{0}\">全部</a>", getUrl("CountryId", ""), CountryId <= 0 ? " class=\"cur\"" : "");
            foreach (Model.Country l in list)
            {
                string css = CountryId == l.ID.Value ? " class=\"cur\"" : "";
                sb.AppendFormat("<a href=\"/schools/list-inner.aspx{0}\" {1}>{2}</a>", getUrl("CountryId", l.ID.Value.ToString()), css, l.Name);
            }
            sb.Append("</dd></dl>");
        }
        return sb.ToString();
    ...
    public string GetCity()
    {
        ...
        if (list.Count > 0)
        {
            ...
            sb.AppendFormat("<a {1} href=\"/schools/list-inner.aspx{0}\">全部</a>", getUrl("CityId", ""), CityId <= 0 ? " class=\"cur\"" : "");
            foreach (Model.Country l in list)
            {
                string css = CityId == l.ID.Value ? " class=\"cur\"" : "";
                sb.AppendFormat("<a href=\"/schools/list-inner.aspx{0}\" {1}>{2}</a>", getUrl("CityId", l.ID.Value.ToString()), css, l.Name);
            }
            sb.Append("</dd></dl>");
        }
        return sb.ToString();
    ...
    public string GetBusiness()
    {
        ...
        if (list.Count > 0)
        {
            ...
            sb.AppendFormat("<a {1} href=\"/schools/list-inner.aspx{0}\">全部</a>", getUrl("BusinessId", ""), BusinessId <= 0 ? " class=\"cur\"" : "");
            foreach (Model.Country l in list)
            {
                string css = BusinessId == l.ID.Value ? " class=\"cur\"" : "";
                sb.AppendFormat("<a href=\"/schools/list-inner.aspx{0}\" {1}>{2}</a>", getUrl("BusinessId", l.ID.Value.ToString()), css, l.Name);
            }
            sb.Append("</dd></dl>");
        }
        return sb.ToString();
    ...
    public string GetLevels()
    {
        ...
        if (list.Count > 0)
        {
            ...
            sb.AppendFormat("<a {1} href=\"/schools/list-inner.aspx{0}\">全部</a>", getUrl("LevelsId", ""), LevelsId <= 0 ? " class=\"cur\"" : "");
            foreach (Model.Country l in list)
            {
                string css = LevelsId == l.ID.Value ? " class=\"cur\"" : "";
                sb.AppendFormat("<a href=\"/schools/list-inner.aspx{0}\" {1}>{2}</a>", getUrl("LevelsId", l.ID.Value.ToString()), css, l.Name);
            }
            sb.Append("</dd></dl>");
        }
        return sb.ToString();
    ...
    public string GetCategories()
    {
        ...
        if (list.Count > 0)
        {
            ...
            sb.AppendFormat("<a {1} href=\"/schools/list-inner.aspx{0}\">全部</a>", getUrl("CategoriesId", ""), CategoriesId <= 0 ? " class=\"cur\"" : "");
            foreach (Model.Country l in list)
            {
                string css = CategoriesId == l.ID.Value ? " class=\"cur\"" : "";
                sb.AppendFormat("<a href=\"/schools/list-inner.aspx{0}\" {1}>{2}</a>", getUrl("CategoriesId", l.ID.Value.ToString()), css, l.Name);
            }
            sb.Append("</dd></dl>");
        }
        return sb.ToString();
    ...
    public string GetShcoolType()
    {
        ...
        sb.AppendFormat("<a {1} href=\"/schools/list-inner.aspx{0}\">全部</a>", getUrl("TypeId", ""), TypeId <= 0 ? " class=\"cur\"" : "");
        sb.AppendFormat("<a href=\"/schools/list-inner.aspx{0}\" {1}>男校</a>", getUrl("TypeId", "1"), TypeId == 1 ? "class=\"cur\"" : "");
        sb.AppendFormat("<a href=\"/schools/list-inner.aspx{0}\" {1}>女校</a>", getUrl("TypeId", "2"), TypeId == 2 ? "class=\"cur\"" : "");
        sb.AppendFormat("<a href=\"/schools/list-inner.aspx{0}\" {1}>男女混校</a>", getUrl("TypeId", "3"), TypeId == 3 ? "class=\"cur\"" : "");
        sb.Append("</dd></dl>");
        return sb.ToString();
    }
    ...
    public string GetInfo()
    {
        ...
        if (sb.ToString() != "")
        {
            sb.Insert(0, "<div class=\"top\"><span href=\"/school/list-inner.aspx\" class=\"all\">全部院校</span><em></em>");
            sb.Append("</div>");
        }
        return sb.ToString();
    }
