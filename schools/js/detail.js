function Comment() {
    ...
    var Num = $.trim($("#txt_GuestNum").val());
    var Grade = $.trim($("#txt_Grade").val());
    var Comment = $.trim($("#txt_Comment").val());
    var AbroadTime = $.trim($("#txt_AbroadTime").val());
    ...
    var item = {
        ...
        Num: Num,
        Comment: Comment,
        Title: $.trim($(".conLeft .name .h1").html()),
...
function fadeXh(obj) {
    var timer;
    function fadeFn() {
        $(obj).find("img").eq(1).fadeOut(100).fadeIn(200).fadeOut(300).fadeIn(400);
    }
