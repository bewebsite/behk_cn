...
public partial class _eyoung_admin_Country_Add : AdminPageBase
{
    private int ID = 0;
    ...
    private void loadData()
    {
        if (ID > 0)
        {
            Model.Country model = bll.GetModelBystrWhere("ID=" + ID + " and Kind=1");
            if (model == null)
            {
            ...
            this.Title = Lit_Title.Text = "相关国家修改";
