...
public partial class eyoung_admin_Categories_Add : AdminPageBase
{
    private int ID = 0;
    ...
    private void loadData()
    {
        if (ID > 0)
        {
            Model.Country model = bll.GetModelBystrWhere("ID=" + ID + " and Kind=5");
            if (model == null)
            {
            ...
            this.Title = Lit_Title.Text = "适用人群类型修改";
    ...
    private void save()
    {
        ...
        Response.Redirect("Categories_List.aspx");
    }
