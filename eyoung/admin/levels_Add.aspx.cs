...
public partial class eyoung_admin_levels_Add : AdminPageBase
{
    private int ID = 0;
    ...
    private void loadData()
    {
        if (ID > 0)
        {
            Model.Country model = bll.GetModelBystrWhere("ID=" + ID + " and Kind=4");
            if (model == null)
            {
            ...
            this.Title = Lit_Title.Text = "适用学习阶段修改";
    ...
    private void save()
    {
        ...
        Response.Redirect("Levels_List.aspx");
    }
