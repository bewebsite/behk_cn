...
public partial class eyoung_admin_Business_Add : AdminPageBase
{
    private int ID = 0;
    ...
    private void loadData()
    {
        if (ID > 0)
        {
            Model.Country model = bll.GetModelBystrWhere("ID=" + ID + " and Kind=3");
            if (model == null)
            {
            ...
            this.Title = Lit_Title.Text = "必益相关业务修改";
    ...
    private void save()
    {
        ...
        Response.Redirect("Business_List.aspx");
    }
