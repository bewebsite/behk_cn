<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeFile="Country_Add.aspx.cs"
    Inherits="_eyoung_admin_Country_Add" %>
    ...
    <div class="mainWrap">
        <div class="smail-nav">
            所在位置：<a href="/eyoung/">首页</a> <em class="fenge">»</em> <span class="lab">
                <asp:Literal ID="Lit_Title" runat="server">相关国家添加</asp:Literal><em></em></span>
        </div>
        <div class="mainContent">
            <div class="editWrap">
                ...
                <div class="sub_btn">
                    ...
                    <a href="Country_List.aspx" class="button">返回列表</a>
                </div>
                <!--内容部分 E-->
            </div>
        </div>
