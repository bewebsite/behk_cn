<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeFile="ENHomeParteners_Add.aspx.cs"
    Inherits="_eyoung_ENHome_ENHomeParteners_Add" %>
        ...
        <div class="mainContent">
            <div class="editWrap">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:FileUpload ID="FileUpload1" runat="server" Width="263px" />&nbsp;&nbsp;<span
                                        style="color: Blue">图片规格： 宽度：100px，高度：100px</span>
                                </td>
                            </tr>
                ...
                <div class="sub_btn">
                    ...
                    <a href="ENHomeParteners_List.aspx" class="button">返回列表</a>
                </div>
                <!--内容部分 E-->
            </div>
        </div>
