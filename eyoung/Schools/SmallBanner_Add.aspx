<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SmallBanner_Add.aspx.cs"
    Inherits="eyoung_Schools_SmallBanner_Add" %>
        ...
        <div class="mainContent">
            <div class="editWrap">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:FileUpload ID="FileUpload1" runat="server" Width="263px" />&nbsp;&nbsp;<span
                                        style="color: Blue">图片规格： 宽度：280px，高度：260px</span>
                                </td>
                            </tr>
                ...
                <div class="sub_btn">
                    ...
                    <a href="SmallBanner_List.aspx" class="button">返回列表</a>
                </div>
                <!--内容部分 E-->
            </div>
        </div>
