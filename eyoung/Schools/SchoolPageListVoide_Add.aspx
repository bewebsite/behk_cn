<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeFile="SchoolPageListVoide_Add.aspx.cs"
    Inherits="_eyoung_Schools_SchoolPageListVoide_Add" %>
    ...
    <div class="mainWrap">
        <div class="smail-nav">
            所在位置：<a href="/eyoung/">首页</a> <em class="fenge">»</em> <span class="lab">
                <asp:Literal ID="Lit_Title" runat="server">学校视频添加</asp:Literal><em></em></span>
        </div>
        <div class="mainContent">
            <div class="editWrap">
                    ...
                    <table class="input tabContent" style="display: table;">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:FileUpload ID="FileUpload1" runat="server" Width="263px" />&nbsp;&nbsp;<span
                                        style="color: Blue">图片规格： 宽度：260px，高度：140px</span>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txt_SchoolName" CssClass="text" runat="server"></asp:TextBox>&nbsp;<em
                                        class="em-red">*</em>
                                </td>
                            </tr>
                            <tr>
                ...
                <div class="sub_btn">
                    ...
                    <a href="SchoolPageListVoide_List.aspx" class="button">返回列表</a>
                </div>
                <!--内容部分 E-->
            </div>
        </div>
