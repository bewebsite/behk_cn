<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SchoolPageListVoide_List.aspx.cs"
    Inherits="_eyoung_Schools_SchoolPageListVoide_List" %>
...
<body>
    ...
    <div class="mainWrap">
        <div class="smail-nav">
            所在位置：<a href="/eyoung/">首页</a> <em class="fenge">»</em> <span class="lab">学校视频列表<em>(共<%=AllCount %>条记录)</em></span>
        </div>
        <div class="mainContent">
            <!--内容部分 S-->
            <div class="bar clearfix">
                <a class="iconButton" href="SchoolPageListVoide_Add.aspx" id="info_add" runat="server">
                ...
                <div class="buttonWrap">
                    ...
                    <asp:TextBox runat="server" ID="searchValue" CssClass="text" placeholder="根据视频名称、院校名称搜索"></asp:TextBox>
                        ...
                        <asp:Repeater ID="rpList" runat="server">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <a href="SchoolPageListVoide_Add.aspx?id=<%# Eval("ID") %>">编辑</a>
                                    </td>
                                </tr>
                            </ItemTemplate>
                        </asp:Repeater>
            ...
            <div class="bar footer-bar clearfix">
                <div class="fl">
                    ...
                    <asp:Button ID="But_CancelIsPass" runat="server" Text="取消显示" CssClass="button" OnClientClick="return check_post();"
