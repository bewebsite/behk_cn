<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SchoolPageListSchool_List.aspx.cs"
    Inherits="_eyoung_Schools_SchoolPageListSchool_List" %>
    ...
    <div class="mainWrap">
        ...
        <div class="mainContent">
            ...
            <div class="bar clearfix">
                <a class="iconButton" href="SchoolPageListSchool_Add.aspx" id="info_add" runat="server">
                        ...
                        <asp:Repeater ID="rpList" runat="server">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <a href="SchoolPageListSchool_Add.aspx?id=<%# Eval("ID") %>">编辑</a>
                                    </td>
                                </tr>
                            </ItemTemplate>
                        </asp:Repeater>
