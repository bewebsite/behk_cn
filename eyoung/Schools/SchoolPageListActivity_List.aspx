<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SchoolPageListActivity_List.aspx.cs"
    Inherits="_eyoung_Schools_SchoolPageListActivity_List" %>

<%@ Register Src="../ascx/header.ascx" TagName="nav" TagPrefix="uc1" %>
<!DOCTYPE html>
<html>
<head id="Head1" runat="server">
    <title>院校最新活动列表</title>
...
<body>
    ...
    <div class="mainWrap">
        <div class="smail-nav">
            所在位置：<a href="/eyoung/">首页</a> <em class="fenge">»</em> <span class="lab">院校最新活动列表<em>(共<%=AllCount %>条记录)</em></span>
        </div>
        <div class="mainContent">
            <!--内容部分 S-->
            <div class="bar clearfix">
                <a class="iconButton" href="SchoolPageListActivity_Add.aspx" id="info_add" runat="server">
                    <span class="addIcon">&nbsp;</span>添加 </a>
                <div class="buttonWrap">
                    <!-- 搜索条件 -->
                    <asp:DropDownList ID="drpIsPass" runat="server">
                        <asp:ListItem Text="--审核--" Value=""></asp:ListItem>
                        <asp:ListItem Text="是" Value="1"></asp:ListItem>
                        <asp:ListItem Text="否" Value="0"></asp:ListItem>
                    </asp:DropDownList>
                    <asp:TextBox runat="server" ID="searchValue" CssClass="text" placeholder="根据活动标题搜索" Width="200"></asp:TextBox>
                        ...
                        <asp:Repeater ID="rpList" runat="server">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <%# Eval("StarDay","{0:MM月dd日}") %><%# GetInfo(Eval("EndDay", "{0:MM月dd日}"))%>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <a href="SchoolPageListActivity_Add.aspx?id=<%# Eval("ID") %>">编辑</a>
                                    </td>
                                </tr>
                            </ItemTemplate>
                        </asp:Repeater>
