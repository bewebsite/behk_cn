<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Schools_List.aspx.cs" Inherits="_eyoung_Schools_Schools_List" %>
    ...
    <div class="mainWrap">
        ...
        <div class="mainContent">
            ...
            <div class="bar clearfix">
                <a class="iconButton" href="Schools_Add.aspx" id="info_add" runat="server"><span
                    class="addIcon">&nbsp;</span>添加 </a>
                <div class="buttonWrap">
                    <asp:DropDownList runat="server" ID="drpType">
                        <asp:ListItem Value="">--学校类型--</asp:ListItem>
                        <asp:ListItem>男校</asp:ListItem>
                    ...
                    <asp:DropDownList ID="drpIsPass" runat="server">
                     ...
                     <asp:DropDownList ID="drpIsGuide" runat="server">
                        <asp:ListItem Text="--推广页显示--" Value=""></asp:ListItem>
                        <asp:ListItem Text="是" Value="1"></asp:ListItem>
                        <asp:ListItem Text="否" Value="0"></asp:ListItem>
                    </asp:DropDownList>
                        ...
                        <asp:Repeater ID="rpList" runat="server">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <a href="/schools/<%#Eval("HtmlName") %>.html" target="_blank">
                                            <img src="<%# Eval("LOGO") %>" height="50" width="50" /></a>
                                    </td>
                                    <td>
                                        <a href="/schools/<%#Eval("HtmlName") %>.html" target="_blank">
                                            <%# Eval("CNName") %></a>
                                    ...
                                    <td>
                                        <a href="Schools_Add.aspx?id=<%# Eval("ID") %>">编辑</a>
                                    </td>
                                </tr>
                            </ItemTemplate>
                        </asp:Repeater>
