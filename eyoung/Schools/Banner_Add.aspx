<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeFile="Banner_Add.aspx.cs"
    Inherits="_eyoung_Schools_Banner_Add" %>
        ...
        <div class="mainContent">
            <div class="editWrap">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:FileUpload ID="FileUpload1" runat="server" Width="263px" />&nbsp;&nbsp;<span
                                        style="color: Blue">图片规格： 宽度：880px，高度：390px</span>
                                </td>
                            </tr>
                ...
                <div class="sub_btn">
                    ...
                    <a href="Banner_List.aspx" class="button">返回列表</a>
                </div>
                <!--内容部分 E-->
            </div>
        </div>
