...
public partial class eyoung_Schools_SmallBanner_Add : AdminPageBase
{
    private int ID = 0;
    ...
    private void loadData()
    {
        if (ID > 0)
        {
            Model.Banner model = bll.GetModelBystrWhere("ID=" + ID + " and Kind=2");
            if (model == null)
            {
    ...
    private void save()
    {
        ...
        Response.Redirect("SmallBanner_List.aspx");
    }
