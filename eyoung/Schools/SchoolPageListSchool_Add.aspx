<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeFile="SchoolPageListSchool_Add.aspx.cs"
    Inherits="_eyoung_Schools_SchoolPageListSchool_Add" %>
        ...
        $().ready(function () {
            ...
            $("#form1").validate({
                rules: {
                    ...
                    drpCountryId: { required: true, digits: true },
                    drpTypeId: { required: true, digits: true },
                ...
                messages: {
                    txt_CNName: { required: "院校中文名不能为空" },
                    txt_ENName: { required: "院校英文名不能为空" },
                    drpCountryId: { required: "国家不能为空", digits: "国家必须为整数" },
                    drpTypeId: { required: "院校类型不能为空", digits: "院校类型必须为整数" },
        ...
        <div class="mainContent">
            <div class="editWrap">
                ...
                <div class="sub_btn">
                    ...
                    <a href="SchoolPageListSchool_List.aspx" class="button">返回列表</a>
                </div>
                <!--内容部分 E-->
            </div>
        </div>
