<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeFile="SchoolPageListNews_Add.aspx.cs"
    Inherits="_eyoung_Schools_SchoolPageListNews_Add" %>

<%@ Register Src="../ascx/header.ascx" TagName="nav" TagPrefix="uc1" %>
<!DOCTYPE html>
<html>
<head id="Head1" runat="server">
    <title>院校最新资讯添加</title>
    ...
    <div class="mainWrap">
        <div class="smail-nav">
            所在位置：<a href="/eyoung/">首页</a> <em class="fenge">»</em> <span class="lab">
                <asp:Literal ID="Lit_Title" runat="server">院校最新资讯添加</asp:Literal><em></em></span>
        </div>
        <div class="mainContent">
            <div class="editWrap">
                    ...
                    <table class="input tabContent" style="display: table;">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txt_Intor" CssClass="text" runat="server" Width="600"></asp:TextBox>&nbsp;<em
                                        class="em-red">*</em>
                                </td>
                            </tr>
                            <tr>
                ...
                <div class="sub_btn">
                    ...
                    <a href="SchoolPageListNews_List.aspx" class="button">返回列表</a>
                </div>
                <!--内容部分 E-->
            </div>
        </div>
