<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SchoolPageListNews_List.aspx.cs"
    Inherits="_eyoung_Schools_SchoolPageListNews_List" %>

<%@ Register Src="../ascx/header.ascx" TagName="nav" TagPrefix="uc1" %>
<!DOCTYPE html>
<html>
<head id="Head1" runat="server">
    <title>院校最新资讯列表</title>
...
<body>
    ...
    <div class="mainWrap">
        <div class="smail-nav">
            所在位置：<a href="/eyoung/">首页</a> <em class="fenge">»</em> <span class="lab">院校最新资讯列表<em>(共<%=AllCount %>条记录)</em></span>
        </div>
        <div class="mainContent">
            <!--内容部分 S-->
            <div class="bar clearfix">
                <a class="iconButton" href="SchoolPageListNews_Add.aspx" id="info_add" runat="server">
                ...
                <div class="buttonWrap">
                    ...
                    <asp:TextBox runat="server" ID="searchValue" CssClass="text" placeholder="根据新闻标题搜索"
                        ...
                        <asp:Repeater ID="rpList" runat="server">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <a href="SchoolPageListNews_Add.aspx?id=<%# Eval("ID") %>">编辑</a>
                                    </td>
                                </tr>
                            </ItemTemplate>
                        </asp:Repeater>
