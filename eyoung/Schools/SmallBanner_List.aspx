<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SmallBanner_List.aspx.cs"
    Inherits="eyoung_Schools_SmallBanner_List" %>
    ...
    <div class="mainWrap">
        ...
        <div class="mainContent">
            ...
            <div class="bar clearfix">
                <a class="iconButton" href="SmallBanner_Add.aspx" id="info_add" runat="server"><span
                        ...
                        <asp:Repeater ID="rpList" runat="server">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <a href="SmallBanner_Add.aspx?id=<%# Eval("ID") %>">编辑</a>
                                    </td>
                                </tr>
                            </ItemTemplate>
                        </asp:Repeater>
