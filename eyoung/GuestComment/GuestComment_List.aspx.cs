...
public partial class _eyoung_GuestComment_GuestComment_List : AdminPageBase
{
    ...
    private string getStrWhere()
    {
        ...
        {
            strWhere += " and (Name like '%" + value + "%' or Email like '%" + value + "%' or Mobile like '%" + value + "%' or City like '%" + value + "%')";
