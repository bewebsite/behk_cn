...
public partial class eyoung_GuestComment_Product_List : AdminPageBase
{
    ...
    private string getStrWhere()
    {
        ...
        {
            strWhere += " and (Name like '%" + value + "%' or StudentName like '%" + value + "%' or Title like '%" + value + "%' or Email like '%" + value + "%' or Mobile like '%" + value + "%' or City like '%" + value + "%')";
