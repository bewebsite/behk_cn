<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Activity_List.aspx.cs" Inherits="eyoung_GuestComment_Activity_List" %>
...
<body>
    ...
    <div class="mainWrap">
        <div class="smail-nav">
            所在位置：<a href="/eyoung/">首页</a> <em class="fenge">»</em> <span class="lab">活动预约列表<em>(共<%=AllCount %>条记录)</em></span>
        </div>
        <div class="mainContent">
            ...
            <div class="bar clearfix">
                ...
                <div class="buttonWrap">
                    ...
                    <asp:TextBox runat="server" ID="searchValue" CssClass="text" placeholder="根据活动主题、姓名、手机号、邮箱、所在城市搜索"
                        ...
                        <asp:Repeater ID="rpList" runat="server">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <a href="Activity_Add.aspx?id=<%# Eval("ID") %>">编辑</a>
                                    </td>
                                </tr>
                            </ItemTemplate>
                        </asp:Repeater>
