<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeFile="JoinUsComment_Add.aspx.cs"
    Inherits="_eyoung_GuestComment_JoinUsComment_Add" %>

<%@ Register Src="../ascx/header.ascx" TagName="nav" TagPrefix="uc1" %>
<!DOCTYPE html>
<html>
<head id="Head1" runat="server">
    <title>加入我们申请添加</title>
    ...
    <div class="mainWrap">
        <div class="smail-nav">
            所在位置：<a href="/eyoung/">首页</a> <em class="fenge">»</em> <span class="lab">
                <asp:Literal ID="Lit_Title" runat="server">加入我们申请添加</asp:Literal><em></em></span>
        </div>
        <div class="mainContent">
            <div class="editWrap">
                    ...
                    <table class="input tabContent" style="display: table;">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txt_CommpanyName" CssClass="text" runat="server"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <th>
                ...
                <div class="sub_btn">
                    ...
                    <a href="JoinUsComment_List.aspx" class="button">返回列表</a>
                </div>
                <!--内容部分 E-->
            </div>
        </div>
