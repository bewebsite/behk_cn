...
public partial class eyoung_GuestComment_Activity_Add : AdminPageBase
{
    private int ID = 0;
    ...
    private void loadData()
    {
        if (ID > 0)
        {
            Model.GuestComment model = bll.GetModelBystrWhere("ID=" + ID + " and Kind=2");
            if (model == null)
            {
            ...
            this.Title = Lit_Title.Text = "活动预约详情";
    ...
    private void save()
    {
        ...
        Response.Redirect("Activity_List.aspx");
    }
