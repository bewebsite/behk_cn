<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GuestComment_List.aspx.cs"
    Inherits="_eyoung_GuestComment_GuestComment_List" %>
...
<body>
    ...
    <div class="mainWrap">
        <div class="smail-nav">
            所在位置：<a href="/eyoung/">首页</a> <em class="fenge">»</em> <span class="lab">在线留言列表<em>(共<%=AllCount %>条记录)</em></span>
        </div>
        <div class="mainContent">
            <!--内容部分 S-->
            <div class="bar clearfix">
                <a class="iconButton" href="GuestComment_Add.aspx" id="info_add" runat="server"><span
                ...
                <div class="buttonWrap">
                    ...
                    <asp:TextBox runat="server" ID="searchValue" CssClass="text" placeholder="根据姓名、手机号、邮箱、所在城市搜索"
                        ...
                        <asp:Repeater ID="rpList" runat="server">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <a href="GuestComment_Add.aspx?id=<%# Eval("ID") %>">编辑</a>
                                    </td>
                                </tr>
                            </ItemTemplate>
                        </asp:Repeater>
