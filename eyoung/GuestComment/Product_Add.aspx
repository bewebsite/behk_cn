<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Product_Add.aspx.cs" Inherits="eyoung_GuestComment_Product_Add" %>
    ...
    <div class="mainWrap">
        <div class="smail-nav">
            所在位置：<a href="/eyoung/">首页</a> <em class="fenge">»</em> <span class="lab">
                <asp:Literal ID="Lit_Title" runat="server">产品留言添加</asp:Literal><em></em></span>
        </div>
        <div class="mainContent">
            <div class="editWrap">
                ...
                <div class="sub_btn">
                    ...
                    <a href="Product_List.aspx" class="button">返回列表</a>
                </div>
                <!--内容部分 E-->
            </div>
        </div>
