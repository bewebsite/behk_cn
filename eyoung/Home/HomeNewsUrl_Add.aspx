<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeFile="HomeNewsUrl_Add.aspx.cs"
    Inherits="_eyoung_Home_HomeNewsUrl_Add" %>
    ...
    <script type="text/javascript">
        $().ready(function () {
            ...
            $("#form1").validate({
                ...
                messages: {
                    FileUpload1: { uploadimg_validate: "上传ICON格式为：jpg,jpeg,bmp,png,gif", chk_image: "请上传ICON" },
                    txt_Name: { required: "名称不能为空" },
    ...
    <div class="mainWrap">
        <div class="smail-nav">
            所在位置：<a href="/eyoung/">首页</a> <em class="fenge">»</em> <span class="lab">
                <asp:Literal ID="Lit_Title" runat="server">新闻连接添加</asp:Literal><em></em></span>
        </div>
        <div class="mainContent">
            <div class="editWrap">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:FileUpload ID="FileUpload1" runat="server" Width="263px" />&nbsp;&nbsp;<span
                                        style="color: Blue">图片规格：不限，根据页面情况定义</span>
                                </td>
                            </tr>
                ...
                <div class="sub_btn">
                    ...
                    <a href="HomeNewsUrl_List.aspx" class="button">返回列表</a>
                </div>
                <!--内容部分 E-->
            </div>
        </div>
