                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:FileUpload ID="FileUpload1" runat="server" Width="263px" />&nbsp;&nbsp;<span
                                        style="color: Blue">图片规格： 宽度：1180px，高度：397px</span>&nbsp;&nbsp;<span
                                        style="color: Blue">手机版图片规格： 宽度：1000px，高度：500px </span>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txt_Sort" Text="0" Width="50px" CssClass="text" runat="server"></asp:TextBox><span
                                        style="padding-left: 5px; color: Red">排序越大越靠前，超过1000的为手机版图片</span>&nbsp;<em class="em-red">*</em>
                                </td>
                            </tr>
                            <tr>
                                <th>
