<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeFile="HomeSchool_Add.aspx.cs"
    Inherits="_eyoung_Home_HomeSchool_Add" %>
        ...
        <div class="mainContent">
            <div class="editWrap">
                ...
                <div class="sub_btn">
                    ...
                    <a href="HomeSchool_List.aspx" class="button">返回列表</a>
                </div>
                <!--内容部分 E-->
            </div>
        </div>
