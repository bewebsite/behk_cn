...
public partial class _eyoung_Home_HomeSchool_List : AdminPageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        But_IsPass.Visible = base.CheckPopedomInfo(1012, 16);
        But_CancelIsPass.Visible = base.CheckPopedomInfo(1012, 16);
    ...
    {
        Model.PageData<Model.HomeSchool> data = bll.GetList(PageSize, base.PageIndex, getStrWhere(), getSort());
    ...
    protected void But_Excel_Click(object sender, EventArgs e)
    {
        ...
        string[] title = { "编号", "中文名", "英文名", "国家", "学校类型", "LOGO", "连接地址", "排序", "显示", "添加时间" };
        DataToExcel.Export(fileName, title, "TB_HomeSchool", "院校列表_" + DateTime.Now.ToString("yyy-MM-dd"), getStrWhere(), getSort());
    }
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        if (rpList.Items.Count > 0)
        {
            ...
            foreach (string _id in arrids)
            {
                ...
                {
                    sql += "UPDATE TB_HomeSchool SET Sort =" + Comm.Help.GetInt(Request.Form[_id]) + " WHERE  ID=" + arr[1] + " ;";
