<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Partner_List.aspx.cs" Inherits="_eyoung_About_Partner_List" %>
    ...
    <div class="mainWrap">
        ...
        <div class="mainContent">
            ...
            <div class="bar clearfix">
                <a class="iconButton" href="Partner_Add.aspx" id="info_add" runat="server"><span
                ...
                <div class="buttonWrap">
                    ...
                    <asp:TextBox runat="server" ID="searchValue" CssClass="text" Width="200" placeholder="根据名称搜索"></asp:TextBox>
                        ...
                        <asp:Repeater ID="rpList" runat="server">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <%# Eval("Kind").ToString() == "1" ? "合作学校" : "合作公司"%>
                                    </td>
                                    <td>
                                        <img src="<%# Eval("Logo") %>" width="50" />
                                    </td>
                                    <td>
                                        <%# Eval("CNName") %>
                                    </td>
                                    ...
                                    <td>
                                        <a href="Partner_Add.aspx?id=<%# Eval("ID") %>">编辑</a>
                                    </td>
                                </tr>
                            </ItemTemplate>
                        </asp:Repeater>
