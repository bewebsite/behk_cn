<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListBanner_List.aspx.cs" Inherits="eyoung_Schools_ListBanner_List" %>
...
<body>
    ...
    <div class="mainWrap">
        <div class="smail-nav">
            所在位置：<a href="/eyoung/">首页</a> <em class="fenge">»</em> <span class="lab">广告位列表<em>(共<%=AllCount %>条记录)</em></span>
        </div>
        <div class="mainContent">
            <!--内容部分 S-->
            <div class="bar clearfix">
                <a class="iconButton" href="ListBanner_Add.aspx" id="info_add" runat="server"><span class="addIcon">
                    &nbsp;</span>添加 </a>
            </div>
            <div>
                        ...
                        <asp:Repeater ID="rpList" runat="server">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <a href="ListBanner_Add.aspx?id=<%# Eval("ID") %>">编辑</a>
                                    </td>
                                </tr>
                            </ItemTemplate>
                        </asp:Repeater>
