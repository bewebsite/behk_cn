<%@ Page Language="C#" AutoEventWireup="true" CodeFile="News_List.aspx.cs" Inherits="_eyoung_News_News_List" %>
    ...
    <div class="mainWrap">
        ...
        <div class="mainContent">
            ...
            <div class="bar clearfix">
                <a class="iconButton" href="News_Add.aspx" id="info_add" runat="server"><span class="addIcon">
                    &nbsp;</span>添加 </a>
                <div class="buttonWrap">
                    ...
                    <asp:DropDownList ID="drpSort" runat="server">
                        ...
                        <asp:ListItem Value="5">预览数正序</asp:ListItem>
                        <asp:ListItem Value="6">预览数倒序</asp:ListItem>
                    </asp:DropDownList>
                    <asp:TextBox runat="server" ID="searchValue" CssClass="text" placeholder="根据新闻标题、文章来源标题搜索" Width="230"></asp:TextBox>
                        ...
                        <asp:Repeater ID="rpList" runat="server">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <a href="/news/<%#Eval("HtmlName") %>.html" target="_blank">
                                            <%# Eval("Title") %></a>
                                    </td>
                                    <td>
                                        <%# GetName(Eval("Kind")) %>
                                    ...
                                    <td>
                                        <a href="News_Add.aspx?id=<%# Eval("ID") %>">编辑</a>
                                    </td>
                                </tr>
                            </ItemTemplate>
                        </asp:Repeater>
