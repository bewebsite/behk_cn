<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EventsType_List.aspx.cs"
    Inherits="_eyoung_Events_EventsType_List" %>
...
<body>
    ...
    <div class="mainWrap">
        <div class="smail-nav">
            所在位置：<a href="/eyoung/">首页</a> <em class="fenge">»</em> <span class="lab">活动类型列表<em>(共<%=AllCount %>条记录)</em></span>
        </div>
        <div class="mainContent">
            <!--内容部分 S-->
            <div class="bar clearfix">
                <a class="iconButton" href="EventsType_Add.aspx" id="info_add" runat="server"><span
                        ...
                        <asp:Repeater ID="rpList" runat="server">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <a href="EventsType_Add.aspx?id=<%# Eval("ID") %>">编辑</a>
                                    </td>
                                </tr>
                            </ItemTemplate>
                        </asp:Repeater>
...
<!-- 上海弈扬文化传播有限公司版权所有，违者必究。http://www.eyoung.net 开发时间：2015-08-31 17:34:38 -->
