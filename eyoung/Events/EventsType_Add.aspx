<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeFile="EventsType_Add.aspx.cs"
    Inherits="_eyoung_Events_EventsType_Add" %>
    ...
    <div class="mainWrap">
        <div class="smail-nav">
            所在位置：<a href="/eyoung/">首页</a> <em class="fenge">»</em> <span class="lab">
                <asp:Literal ID="Lit_Title" runat="server">活动类型添加</asp:Literal><em></em></span>
        </div>
        <div class="mainContent">
            <div class="editWrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span style="color: Red; padding-left: 5px">只有通过审核，内容才能在前台页面显示</span>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <div class="sub_btn">
                    ...
                    <a href="EventsType_List.aspx" class="button">返回列表</a>
                </div>
                <!--内容部分 E-->
            </div>
        </div>
