<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Events_List.aspx.cs" Inherits="_eyoung_Events_Events_List" %>
...
<body>
    ...
    <div class="mainWrap">
        <div class="smail-nav">
            所在位置：<a href="/eyoung/">首页</a> <em class="fenge">»</em> <span class="lab">精彩活动列表<em>(共<%=AllCount %>条记录)</em></span>
        </div>
        <div class="mainContent">
            <!--内容部分 S-->
            <div class="bar clearfix">
                <a class="iconButton" href="Events_Add.aspx" id="info_add" runat="server"><span class="addIcon">
                    &nbsp;</span>添加 </a>
                <div class="buttonWrap">
                    ...
                    <asp:DropDownList ID="drpIsHot" runat="server">
                        <asp:ListItem Text="--推荐--" Value=""></asp:ListItem>
                        <asp:ListItem Text="是" Value="1"></asp:ListItem>
                        <asp:ListItem Text="否" Value="0"></asp:ListItem>
                    </asp:DropDownList>
                    ...
                    <asp:TextBox runat="server" ID="searchValue" CssClass="text" placeholder="根据活动标题搜索" Width="150"></asp:TextBox>
                        ...
                        <asp:Repeater ID="rpList" runat="server">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <a target="_blank" href="/events/<%# Eval("HtmlName") %>.html">
                                            <%# Eval("CNTitle") %></a>
                                    </td>
                                    <td>
                                        <%# DateTime.Parse(Eval("StarDay").ToString()).ToString("M月d日") %>
                                        <%#GetInfo2(Eval("EndDay")) %>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <a href="Events_Add.aspx?id=<%# Eval("ID") %>">编辑</a>
                                    </td>
                                </tr>
                            </ItemTemplate>
                        </asp:Repeater>
            ...
            <div class="bar footer-bar clearfix">
                <div class="fl">
                    ...
                    <asp:Button ID="But_IsHot" runat="server" Text="推荐" CssClass="button" OnClientClick="return check_post();"
                        OnClick="But_IsHot_Click" />
                    <asp:Button ID="But_CancelIsHot" runat="server" Text="不推荐" CssClass="button" OnClientClick="return check_post();"
                        OnClick="But_CancelIsHot_Click" />
