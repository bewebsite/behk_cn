<%@ Page Language="C#" AutoEventWireup="true" CodeFile="springfestival.aspx.cs" Inherits="springfestival" %>
...
<div class="nheader">
    ...
    <video id="example_video_1"  class="video-js vjs-default-skin" controls preload="none" width="1024" height="728"
      poster="http://video-js.zencoder.com/oceans-clip.png"
      data-setup="{}">
      
    <source src="images/befullversion.mp4" type='video/mp4' />
    ...
    <script>
    videojs.options.flash.swf = "video/William.swf";
        </script>
    </div>
    </form>
